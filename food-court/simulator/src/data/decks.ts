...
export const DECKS: DeckDefinition[] = [
  ...
  },
  {
    ...
    flag: '🍜',
    color: '#c03a2b',
    ability: 'Each distinct pair of served recipes grants +1 serve value.',
    endCondition: 'Get 4 Tips Cards in tracking.',
    ...
    recipes: [
      ...
      { name: 'Lo Mein', difficulty: 'hard', emoji: '🍜' },
  ...
  },
  {
    ...
    flag: '🍛',
    color: '#d77825',
    ability: 'Each spiced dish grants +1 serve value.',
    endCondition: 'Get 4 Tips Cards in tracking.',
  ...
  },
  {
    ...
    flag: '🍔',
    color: '#274b8f',
    ability: 'Each dish can take 1 Ingredient Card above its printed ingredient limit.',
    endCondition: 'Get 4 Tips Cards in tracking.',
  ...
  },
  {
    ...
    flag: '🍣',
    color: '#cc5f7a',
    ability: 'Gain +1 serve value if at least one seasoning Ingredient is used exactly once.',
    endCondition: 'Get 4 Tips Cards in tracking.',
  ...
  },
  {
    ...
    flag: '🌮',
    color: '#157f7a',
    ability: 'Hot Ingredients can also be added to recipes without extra ingredient slots.',
    endCondition: 'Get 4 Tips Cards in tracking.',
    tracking: 'Non-hot Ingredient Cards.',
    ingredients: [
