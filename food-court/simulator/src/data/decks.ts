...
export const DECKS: DeckDefinition[] = [
  {
    ...
    flag: '🍝',
    color: '#1f7a4d',
    ability: 'Dishes served with their exact pasta Ingredient Card gain +2 serve value.',
  ...
  },
  {
    ...
    flag: '🍛',
    color: '#d77825',
    ability: 'Each served dish with at least one spice Ingredient Card gains +1 serve value.',
    endCondition: 'Get 4 Tips Cards in tracking.',
    tracking: 'Spice Ingredient Cards.',
    ingredients: [
      ...repeat([], 6, 'ingredient', '🍚'),
      { name: 'Cumin', count: 1, type: 'ingredient', emoji: '🌰', tags: ['spice'] },
      { name: 'Saffron', count: 1, type: 'ingredient', emoji: '🍯', tags: ['spice'] },
      ...
      { name: 'Turmeric', count: 1, type: 'ingredient', emoji: '🌿', tags: ['spice'] },
      { name: 'Clove', count: 1, type: 'ingredient', emoji: '🌰', tags: ['spice'] },
  ...
  },
  {
    ...
    flag: '🍔',
    color: '#274b8f',
    ability: 'Once per meal, 1 extra Ingredient Card can be added to a dish above its requirements.',
    endCondition: 'Get 4 Tips Cards in tracking.',
    tracking: 'Recipe cards.',
    ingredients: [
      ...repeat([], 12, 'ingredient', '🍔'),
    ...
    drinks: [
      { name: 'Coke', emoji: '🥤', requirement: 'Play if you served at least 2 burger dishes.' },
      { name: 'Bourbon', emoji: '🥃', requirement: 'Play if you served at least 2 steak dishes.' },
  ...
  },
  {
    ...
    flag: '🍣',
    color: '#cc5f7a',
    ability: 'A meal with 2+ recipes and seasoning gains +1; different seasoning pairs gain +1.',
    endCondition: 'Get 4 Tips Cards in tracking.',
  ...
  },
  {
    ...
    flag: '🌮',
    color: '#157f7a',
    ability: 'The first hot Ingredient gains +1 serve value; up to 2 hot Ingredients can be added.',
    endCondition: 'Get 4 Tips Cards in tracking.',
    tracking: 'Hot Ingredient Cards, with at most 2 of the same name.',
    ingredients: [
      ...repeat([], 6, 'ingredient', '🌮'),
      { name: 'Cayenne Pepper', count: 3, type: 'ingredient', emoji: '🌶️', tags: ['hot'] },
      { name: 'Jalapeno', count: 2, type: 'ingredient', emoji: '🌶️', tags: ['hot'] },
