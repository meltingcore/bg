...
* Games now end after resolving 10 customers.

FIXES:

* Multiplayer fixes and rules alignment in the webapp and the simulator.
...
* The default hand limit being 7 is now clearly stated in the rules.
